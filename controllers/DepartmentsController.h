...
class DepartmentsController:public drogon::HttpController<DepartmentsController>
{
  public:
    METHOD_LIST_BEGIN
		  ...
		  ADD_METHOD_TO(DepartmentsController::getAllDepartments,"/departments", Get); 
    ...
    void getAllDepartments(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback) const;
